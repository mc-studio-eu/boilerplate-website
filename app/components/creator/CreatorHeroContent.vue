...
onMounted(() => {
  gsap.fromTo(".creator-hero-title", 
    { 
      opacity: 0, 
      filter: "blur(20px)",
      y: 20
  ...
  gsap.fromTo(".creator-hero-subtitle", 
    { 
      opacity: 0, 
      filter: "blur(15px)",
      y: 15
