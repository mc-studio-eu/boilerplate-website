<template>
  <div class="flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 lg:gap-9 mt-6 sm:mt-8 md:mt-10 lg:mt-12 px-2 sm:px-4 w-full max-w-[340px] sm:max-w-none">
    <!-- Badge 1: Experience -->
    <div class="badge flex items-center justify-center gap-1.5 sm:gap-2 h-7 sm:h-8 md:h-9 py-1 sm:py-1.5 px-2.5 sm:px-3 md:px-4 bg-white border border-[#f0bf6c] rounded-md sm:rounded-lg">
    ...
    <div class="badge flex items-center justify-center gap-1.5 sm:gap-2 h-7 sm:h-8 md:h-9 py-1 sm:py-1.5 px-2.5 sm:px-3 md:px-4 bg-white border border-[#f0bf6c] rounded-md sm:rounded-lg">
      <!-- French Flag -->
      <div class="flex w-5 h-3 sm:w-6 sm:h-4 rounded-[2px] overflow-hidden shadow-sm shrink-0">
...
.badge:hover {
  ...
  box-shadow: 0 2px 8px rgba(240, 191, 108, 0.2);
}
</style>
